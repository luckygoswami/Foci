...
export const Fire: React.FC<FireProps> = ({ variant = 'color', ...props }) => {
  ...
  const { gradientStart, gradientEnd, midFlame, coreFlame, stroke } =
    ...
    <svg
      ...
      {variant === 'outline' ? (
        ...
        <g
          ...
          <path d="M95 183.812c9.25 0 9.25 17.129 21 40 7.824 15.229-3.879 31-21 31s-26-13.879-26-31c0-17.12 16.75-40 26-40z" />
        </g>
      ) : (
        // Filled version
        <g fillRule="evenodd">
