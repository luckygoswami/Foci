...
export default function GroupDetailsPage() {
  ...
  useEffect(() => {
    ...
    fetchGroupInvitesBySender(userData.userId, groupId).then(setSentInvites);
  }, [showInviteModal]);
  ...
  function handleInvite(recipient: Friend & { invited: boolean }) {
    ...
    sendGroupInvite(newInvite).catch((err) => console.error(err));
  ...
  function handleJoin() {
    ...
    addGroupMember(groupId, userObj);
  ...
  function handleLeave() {
    ...
    removeGroupMember(groupId, memberObj!);
